...
public class FileScanner {
     ...
     */
    public FileScanner(String nome) throws FileNotFoundException {
        try {
     ...
     */
    public CadPromissoria leArquivo(int tam) throws NoSuchElementException, ArrayIndexOutOfBoundsException {
     ...
     */
    private Promissoria separaDados(String linha) throws NoSuchElementException {
        String[] dados;
        String nome, cpf, aux;
        Calendar venc;
        double valor;
    ...
    /**
     * Metodo para separar o dia, mes e o ano de uma data. Eles estao separados por
     * / de cria uma data com esses inteiros.
     * 
